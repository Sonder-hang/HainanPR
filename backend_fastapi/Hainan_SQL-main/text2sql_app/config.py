...
# —— OpenAI 兼容 API ——
OPENAI_API_KEY = "sk-Ltwab4WTKOGcWd1Q19219e93B45c45B987F7DaE239Ba4197"
...
# —— SSH 隧道（自动建立，无需手动开终端） ——
SSH_TUNNEL_ENABLED = True                # 设为 False 则直连本地 MySQL，不走隧道
...
SSH_KEY_PATH = "C:/Users/46210/.ssh/id_ed25519"                        # 私钥路径（支持 ~ 展开）；留空则仅用密码
SSH_REMOTE_BIND = ("127.0.0.1", 3306)    # 服务器上 MySQL 监听的地址和端口

# —— MySQL ——
# SSH_TUNNEL_ENABLED=True 时，MYSQL_HOST 和 MYSQL_PORT 由隧道自动设置，下面两项被忽略。
# SSH_TUNNEL_ENABLED=False 时，直连下面配置的地址。
MYSQL_HOST = "localhost"
MYSQL_PORT = 3306
MYSQL_USER = "root"
MYSQL_PASSWORD = "Ecust@1234"
MYSQL_DATABASE = "Hainan"
